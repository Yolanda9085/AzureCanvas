  ...
  const func = (root, initTheme, changeTheme) => {
    ...
    components.onclick = () => {
      if (isMoved) {
        ...
        cloud.style.transform = "translateY(0em)";
        cloudLight.style.transform = "translateY(0em)";
        ...
        mainButton.style.transform = "translateX(92em)";
        ...
        daytimeBackground[0].style.transform = "translateX(90em)";
    ...
    mainButton.addEventListener("mouseout", function () {
      ...
      if (isMoved) {
        mainButton.style.transform = "translateX(85em)";
        daytimeBackground[0].style.transform = "translateX(90em)";
        daytimeBackground[1].style.transform = "translateX(80em)";
        daytimeBackground[2].style.transform = "translateX(50em)";
